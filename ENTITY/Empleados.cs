...
namespace ENTITY
{
    public class Empleados : Datos_Personales
    {
        ...
        public Empleados(List<Cliente> lista_de_clientes, List<Servicios> lista_de_servicios, int codigo_empresa, int cupos_disponibles, string cargo, DateTime fecha_de_inicio, DateTime fecha_de_final, string estado)
        {
