    ...
    public class Funciones_de_la_reservacion
    {
        ...
        private void Enviar_Datos(Reservacion datos_de_la_reservacion)
        {
            ...
            using (OracleCommand cmd = new OracleCommand("PK_INGRESAR_UNA_RESERVACION", ora))
            {
              ...
              //  cmd.Parameters.Add("p_nombre", OracleDbType.Varchar2).Value = reservacion.nombre_del_servicio;
               // cmd.Parameters.Add("p_precio", OracleDbType.Int16).Value = reservacion.precio;

                //El tiempo toca descomponarlo en string para poder guardarlo como se debe
                //cmd.Parameters.Add("p_tiempo", OracleDbType.Varchar2).Value = reservacion.tiempo_promedio;
        ...
        private void Enviar_actualizacion(Reservacion datos_de_la_reservacion)
        {
            ...
            //comando.Parameters.Add("p_nombre", OracleDbType.Varchar2).Value = reservacion.nombre_del_servicio;
            //comando.Parameters.Add("p_precio", OracleDbType.Double).Value = reservacion.precio;
            //comando.Parameters.Add("p_tiempo", OracleDbType.Varchar2).Value = reservacion.tiempo_promedio;
