...
namespace DAL
{
    public class Funcion_de_los_servicios
    {
        ...
        public Boolean Ingresar_Una_Ubicacion(Datos_login Conexion_del_usuario, Servicios datos_de_un_servicio)
        {
        ...
        //Funcion para poder traer todos los servicios existentes
        public DataTable Consultar_Un_Empleado(Datos_login Conexion_del_Usuario, Servicios datos_del_servicio)
        {
